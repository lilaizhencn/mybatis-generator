...
public abstract class IntrospectedTable {
  ...
  protected enum InternalAttribute {
    ...
    ATTR_MYBATIS3_JAVA_MAPPER_TYPE, ATTR_MYBATIS3_JAVA_SERVICE_TYPE, ATTR_MYBATIS3_JAVA_SERVICE_IMPL_TYPE, ATTR_MYBATIS3_JAVA_CONTROLLER_TYPE,
  ...
  protected void calculateJavaClientAttributes() {
    ...
    String targetControllerPackage =
        javaClientGeneratorConfiguration.getProperty("targetControllerPackage");
    if (targetControllerPackage == null) {
      targetControllerPackage = packageName;
    }
    sb.append(targetControllerPackage);
    sb.append(".");
    sb.append(prefix);
    sb.append("AdminController");
  ...
  public void setSqlMapAliasedFullyQualifiedRuntimeTableName(
    ...
    this.internalAttributes.put(
        ...
        sharding ? "${shardTable.name}" : aliasedFullyQualifiedRuntimeTableName);
  }
  ...
  public String getMyBatis3JavaControllerType() {
    return this.internalAttributes.get(InternalAttribute.ATTR_MYBATIS3_JAVA_CONTROLLER_TYPE);
  }

  public void setMyBatis3JavaControllerType(String mybatis3JavaControllerType) {
    this.internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_JAVA_CONTROLLER_TYPE,
