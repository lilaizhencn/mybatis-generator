 ...
 * @author xionghui
 */
public class SelectByPagerWithoutBLOBsElementGenerator extends AbstractXmlElementGenerator {

  public SelectByPagerWithoutBLOBsElementGenerator() {
    super();
  }
  ...
  public void addElements(XmlElement parentElement) {
    ...
    answer.addAttribute(new Attribute("id", "selectByPager"));
    ...
    ifElement
        .addAttribute(new Attribute("test", "pager.sortItem != null and pager.sortItem != ''"));
    ...
    if (this.context.getPlugins().sqlMapSelectByExampleWithoutBLOBsElementGenerated(answer,
      ...
      if (commentGenerator instanceof CustomizationCommentGenerator) {
        ((CustomizationCommentGenerator) commentGenerator).addFinishComment(parentElement);
      }
    }
  }
}
